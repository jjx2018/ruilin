<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainFromMag.aspx.cs" Inherits="AppBoxPro.BaseDataMag.MainFromMag" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" CssClass="blockpanel" ShowBorder="true" ShowHeader="false" Title="" EnableCollapse="false"
            ...
            <Columns>
                <f:RowNumberField />
                  <f:RenderField Width="150px" ColumnID="MainFromCode"   EnableLock="true" Locked="true"  DataField="MainFromCode"
                      HeaderText="主要来源代码">
                    <Editor>
                        <f:TextBox ID="tbxMainFromCode"  Required="true" runat="server">
                        </f:TextBox>
                    </Editor>
                </f:RenderField>
                 <f:RenderField Width="200px"  EnableLock="true" Locked="true"  ColumnID="MainFromName" DataField="MainFromName"
                      HeaderText="主要来源名称">
                    <Editor>
                        <f:TextBox ID="tbxMainFromName" Required="true" runat="server">
                        </f:TextBox>
                    </Editor>
                </f:RenderField>
