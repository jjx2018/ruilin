<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreMag.aspx.cs" Inherits="AppBoxPro.BaseDataMag.StoreMag" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" CssClass="blockpanel" ShowBorder="true" ShowHeader="false" Title="" EnableCollapse="false"
            ...
            <Columns>
                <f:RowNumberField />
                  <f:RenderField Width="150px" ColumnID="StoreCode"   EnableLock="true" Locked="true"  DataField="StoreCode"
                      HeaderText="仓库代码">
                    <Editor>
                 ...
                 <f:RenderField Width="200px"  EnableLock="true" Locked="true"  ColumnID="StoreName" DataField="StoreName"
                      HeaderText="仓库名称">
                    <Editor>
