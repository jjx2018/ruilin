<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockConfirmDetail.aspx.cs" Inherits="AppBoxPro.PlanMag.StockConfirmDetail" %>
                    ...
                    <Toolbars>
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                               ...
                               <f:Button ID="btnCopy" Pressed="true" Enabled="true" Hidden="true"  runat="server" Text="复制" Icon="PageCopy" OnClick="btnCopy_Click"></f:Button>
                                
                               <f:Button ID="btnNew" OnClick="btnNew_Click"  Pressed="true" Hidden="true" Enabled="true"  Text="新增" Icon="Add" runat="server">
                        </f:Button>
                                 <f:Button ID="btnZUHE" OnClick="btnZUHE_Click" Pressed="true" Hidden="true" Enabled="true"  Text="添加组合件" Icon="Add" runat="server">
                        </f:Button>
                          <f:Button ID="btnSave"  OnClick="btnSave_Click"  Pressed="true" Hidden="false" Enabled="true" runat="server" Icon="SystemSave"    Text="保存">
                            </f:Button> 
                        <f:Button ID="btnDelete"  Pressed="true" Enabled="true" Hidden="true" OnClick="btnDeleteSelected_Click" Text="删除" Icon="Delete"  runat="server">
                        </f:Button>
                          ...
                          <f:Button ID="btnPLSend" Hidden="false"  Pressed="true" Enabled="true" OnClick="btnPLSend_Click" Text="批量发送确认单" Icon="PageWhiteStack"  runat="server">
                                 ...
                                 <f:Button ID="btnNewPLSend" Hidden="false"  Pressed="true" Enabled="true" OnClick="btnNewPLSend_Click" Text="新产品批量确认" Icon="PageWhiteStack"  runat="server">
                        </f:Button>  
...
<f:RenderField Width="200px" ColumnID="ItemNo" SortField="ItemNo" DataField="ItemNo" HeaderText="料号" EnableColumnEdit="false"
                 ...
                 <f:RenderField Width="150px" ColumnID="Spec" SortField="Spec" MinWidth="60px" DataField="Spec" TextAlign="Center" ExpandUnusedSpace="true" EnableColumnEdit="false"
                      HeaderText="规格" >
                    <Editor>
                 ...
                 <f:RenderField Width="140px" ColumnID="Material" SortField="Material" DataField="Material" TextAlign="Center"
                 ...
                 <f:RenderField Width="140px" ColumnID="SurfaceDeal" SortField="SurfaceDeal" DataField="SurfaceDeal" TextAlign="Center"
                 ...
                 <f:RenderField Width="90px" ColumnID="ProUsingQuantity" EnableColumnEdit="false" SortField="ProUsingQuantity" DataField="ProUsingQuantity" TextAlign="Center"
                      HeaderText="产品用量">
                    <Editor>
...
<f:RenderField Width="100px" ColumnID="SupplierId" DataField="SupplierId" SortField="SupplierId"
                      HeaderText="供应商" RendererFunction="renderProvider"  EnableColumnEdit="false">
                    ...
                    <f:RenderField Width="100px" Hidden="false" ColumnID="ZuHe" EnableColumnEdit="false" DataField="ZuHe" TextAlign="Center"
                      HeaderText="ZuHe">
                    <Editor>
                    ...
                    <f:RenderField Width="100px" Hidden="false" ColumnID="ParentSN" EnableColumnEdit="false" DataField="ParentSN" TextAlign="Center"
                      HeaderText="ParentSN">
                    <Editor>
...
<f:WindowField ColumnID="remark" TextAlign="Center" Icon="ApplicationAdd" HeaderText="添加备注" DataToolTipField="Remark" WindowID="Window2"
                        ...
                        <f:BoundField ColumnID="ISN" Hidden="false" DataField="ISN" HeaderText="ISN"></f:BoundField>
