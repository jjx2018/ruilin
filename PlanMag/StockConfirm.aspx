<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockConfirm.aspx.cs" Inherits="AppBoxPro.PlanMag.StockConfirm" %>
...
<body>
 ...
 <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false" SummaryPosition="Bottom" EnableSummary="true" EnableTextSelection="true" 
                    EnableCheckBoxSelect="true" AllowCellEditing="false" ClicksToEdit="1" 
                    ...
                    <Toolbars>
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                               ...
                               <f:Button ID="btnCopy" Pressed="true" Enabled="false" Hidden="true"  runat="server" Text="复制" Icon="PageCopy" OnClick="btnCopy_Click"></f:Button>
                                
                               <f:Button ID="btnNew" OnClick="btnNew_Click"  Hidden="true" Pressed="true" Enabled="false"  Text="新增" Icon="Add" runat="server">
                        </f:Button>
                                 <f:Button ID="btnZUHE" OnClick="btnZUHE_Click" Hidden="true" Pressed="true" Enabled="false"  Text="添加组合件" Icon="Add" runat="server">
                        </f:Button>
                          <f:Button ID="btnSave"  OnClick="btnSave_Click"  Hidden="true" Pressed="true" Enabled="false" runat="server" Icon="SystemSave"    Text="保存">
                            </f:Button> 
                        <f:Button ID="btnDelete"  Hidden="true" Pressed="true" Enabled="false" OnClick="btnDeleteSelected_Click" Text="删除" Icon="Delete"  runat="server">
                        </f:Button>
...
<f:RenderField Width="100px" ColumnID="SupplierId" DataField="SupplierId"
                    ...
                    <Editor>
                         <f:DropDownList Required="false" runat="server" ID="ddlSupplierId">
                          ...
                          <f:WindowField ColumnID="viewField" Hidden="false" HeaderText="备货确认单" Title="备货确认单" ToolTip="备货确认单" TextAlign="Center" Icon="ApplicationViewIcons" WindowID="Window1" DataIFrameUrlFields="SN,FSN" DataIFrameUrlFormatString="~/StoreConfirm/SendInstruction.aspx?id={0}&fsn={1}&k=1"
                            Width="100px" />
                      
                        <f:LinkButtonField ColumnID="deleteField" Hidden="true"  TextAlign="Center" Icon="Delete" ToolTip="删除" HeaderText="删除"
