<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="changepassword.aspx.cs" Inherits="AppBoxPro.admin.changepassword" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" ShowHeader="false" ShowBorder="false"
            BodyPadding="5px" runat="server" AutoScroll="true" Width="600px">
            <Items>
