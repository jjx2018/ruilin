<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductInStockList.aspx.cs" Inherits="AppBoxPro.product.ProductInStockList" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
            ...
            <Columns>
                ...
                <f:BoundField DataField="Quantity" ColumnID="Quantity" SortField="Quantity" Width="90px" HeaderText="生产数量" />
