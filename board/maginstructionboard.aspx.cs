...
{
    public partial class maginstructionboard :PageBase
    {
        ...
        private void BindGrid()
        {
            using (var appdb = new AppContext())
            {
                ...
                //            ItemName = a.ItemName,
                //            MainFrom = a.MainFrom,
                //            UsingQuantity = a.UsingQuantity,
                //            ConfirmQuantity = a.ConfirmQuantity,
                //            RealUsingQuantity = a.RealUsingQuantity,
                //            IsConfirm = a.IsConfirm,
                //            Spec = a.Spec,
                //            Material = a.Material,
                //            SurfaceDeal = a.SurfaceDeal,
                //            Sclass = a.Sclass,
                //            ReceiveDept = a.ReceiveDept,
                //            Receiver = a.Receiver,
                //            ConfirmDate = a.ConfirmDate,
                //            BarCode = a.BarCode,
                //            Remark = a.Remark,
                //            InputeDate = a.InputeDate
                //        };
       ...
       BaseFont.NOT_EMBEDDED);
        ...
        {
            string html = @"<table style='width:90%; border:3px solid #000;margin:0px auto;' cellpadding='0' cellspacing='0'>
            <tr style=' font-size: 25px; font-weight:600; '>
                <td colspan='2' style='border-bottom: solid 3px #000; height: 80px; '>
                    &nbsp;订单号：$orderno
                </td>
            </tr>
            <tr style=' font-size: 25px; font-weight: 600; height: 80px; '>
                <td colspan='2' style='border-bottom:solid 3px black; '>
                    &nbsp;产品名称：$proname                   
                </td>
            </tr>
            <tr style=' font-size: 25px; font-weight: 600; height: 80px; '>
                <td colspan='2' style='border-bottom: solid 3px #000;'>
                    &nbsp;物料名称：$itemname
                </td>
            </tr>

            <tr style=' font-size: 25px;  font-weight:600;'>
                <td  style=' height: 80px; font-weight: 600; border-bottom: solid 3px #000;width:50%;border-right:solid 3px #000;'>
                    &nbsp;规格：$spec
                </td>
                <td  style=' height: 80px; font-weight: 600; border-bottom: solid 3px #000; width: 50%;'>
                    &nbsp;材质：$material
                </td>
            </tr>
        <tr style=' font-size: 25px;  font-weight:600;'>
        ...
        {
            Instruction row = e.DataItem as Instruction;
            //录入日期
            DateTime dt = (DateTime)row.InputeDate;
            TimeSpan ts = DateTime.Now - dt;
            if (ts.TotalDays > 1)
            {
                //超期1天以上黄色
                e.RowCssClass = "coloryellow";
            }
            if (ts.TotalDays > 2)
            {
                //超期2天以上红色
                e.RowCssClass = "colorred";
            }
        }
