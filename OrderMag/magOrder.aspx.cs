    ...
    public partial class magOrder : PageBase
    {
        ...
        protected void Grid2_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "toBOM")
            {
                ...
                iframeUrl: 'BomMag/RealBom.aspx?sn=" + ID + @"&od=" + Grid2.Rows[e.RowIndex].Values[1].ToString() + @"&id=" + Grid2.Rows[e.RowIndex].Values[2].ToString() + @"&q=" + Grid2.Rows[e.RowIndex].Values[4].ToString() + @"',
