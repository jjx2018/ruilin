...
{
    public partial class showNewOrder : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                btnNew.OnClientClick = Window2.GetShowReference("~/OrderMag/order_new.aspx", "新增订单");
        ...
        private void BindGrid()
        {
            using (var appdb = new AppContext())
            {
                ...
                var qqq = from a in appdb.orderheader
                          where a.IsConfirm == 0 && a.InputerDate >= now
                          select a;
        ...
        private void readExcel(string filename)
        {
            ...
            try
            {
                ...
                using (OleDbConnection conn = new OleDbConnection(connstring))
                {
                    ...
                    int i = 0;
                    SQLHelper.DbHelperSQL.SetConnectionString("");
                    string OrderNo = "", LotNo = "", ClientCode = "", ClientOrderNo = "", RecOrderPersonID = "", RecOrderPerson = "", RecOrderDate = "", SendOrderDate = "", OutGoodsDate = "", checkman = "", CheckDate = "", ContainerType = "", ischeck = "";
                    ...
                    if (dt != null && dt.Rows.Count >= 6)
                    {
                        ...
                        if (dtitem == null || dtitem.Rows.Count == 0)
                        {
                            ...
                            sql = "insert into OrderHeader(OrderNo,LotNo,ClientCode,ClientOrderNo,RecOrderPerson,RecOrderDate,SendOrderDate,OutGoodsDate,Inputer,InputerDate,IsCheck,OrderExcel,ContainerType,Checker,CheckDate) values('" + OrderNo + "','" + LotNo + "','" + ClientCode + "','" + ClientOrderNo + "','" + RecOrderPerson + "','" + RecOrderDate.Replace(".", "-") + "','" + SendOrderDate.Replace(".", "-") + "','" + OutGoodsDate.Replace(".", "-") + "','" + User.Identity.Name + "',getdate()," + ischeck + ",'" + filename + "','" + ContainerType + "','" + checkman + "','" + CheckDate + "')";
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    sql = "update orderheader set IsConfirm=1 where sn=" + Grid1.DataKeys[i][0].ToString();
                    al.Add(sql);
                }
                SQLHelper.DbHelperSQL.SetConnectionString("");
