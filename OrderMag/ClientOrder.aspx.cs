...
{
    public partial class ClientOrder : PageBase
    {
        ...
        protected void btnBOM_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //Alert.Show(Grid2.Rows[i].Values[1].ToString() + "----" + Grid2.Rows[i].Values[3].ToString() + "----" + Grid2.Rows[i].Values[5].ToString() + "-----" + Grid2.DataKeys[i][0].ToString() + "----" + Grid2.Rows[i].Values.GetValue(6).ToString());
