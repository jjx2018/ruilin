...
{
    public partial class magOrderHeader : PageBase
    {
        ...
        private void BindGrid()
        {
            using (var appdb = new AppContext())
            {
                ...
                var qqq = from a in appdb.orderheader
                          ...
                          select new {a.SN,a.OrderNo,a.ClientOrderNo,a.LotNo,a.ClientCode,a.RecOrderPerson,a.RecOrderDate,a.CheckDate,a.OutGoodsDate,a.ContainerType,a.Inputer,a.InputerDate,a.IsCheck,c.ChineseName,a.IsBom,a.OrderType , Updater = e.ChineseName,a.UpdateDate};
                ...
                foreach (DictionaryEntry de in htClickColsName)
                {
                    switch (de.Key.ToString())
                    {
                        ...
                        case "ClientOrderNo":
                            ...
                            break;
                        case "LotNo":
                            qqq = qqq.Where(u => u.LotNo == de.Value.ToString());
                            break;
                        case "ClientCode":
                            qqq = qqq.Where(u => u.ClientCode == de.Value.ToString());
                            break;
                        case "RecOrderPerson":
                            qqq = qqq.Where(u => u.RecOrderPerson == de.Value.ToString());
                            break;
                        case "RecOrderDate":
