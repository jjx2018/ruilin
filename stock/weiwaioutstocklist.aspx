<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="weiwaioutstocklist.aspx.cs" Inherits="AppBoxPro.stock.weiwaioutstocklist" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                ...
                <f:Toolbar ID="Toolbar2" runat="server">
                    <Items>
                        <f:SimpleForm ID="SF2" runat="server" Width="100%" ShowBorder="false" ShowHeader="false" LabelWidth="100px" Layout="HBox" BoxConfigChildMargin="0 5 0 5px">
                            <Items>
                                <f:TextBox runat="server" EmptyText="关键词搜索" ID="tbxSearch" Width="250px"></f:TextBox>

                                <f:DatePicker ID="DateFrom" DateFormatString="yyyy-MM-dd" LabelWidth="40px" Width="120px" runat="server" Label="开始"></f:DatePicker>
                                <f:DatePicker ID="DateTo" DateFormatString="yyyy-MM-dd" LabelWidth="40px" Width="120px" runat="server" Label="结束" CompareControl="DateFrom" CompareOperator="GreaterThan" CompareMessage="结束日期应大于开始日期"></f:DatePicker>
            ...
            <Columns>
                ...
                <f:BoundField DataField="SendOutPlanNo" SortField="SendOutPlanNo" Width="130px" HeaderText="委外计划单号" Hidden="true" />
                ...
                <f:BoundField DataField="Quantity" ColumnID="Quantity" SortField="Quantity" Width="90px" HeaderText="委外数量" />
                <f:RenderField DataField="InstockQuantity" ColumnID="InstockQuantity" HeaderText="已入库数">
                </f:RenderField>
                <f:WindowField HeaderText="入库" Icon="ApplicationOsxAdd" WindowID="Window1" DataIFrameUrlFormatString="~/stock/weiwaioutstocknew.aspx?SN={0}&&mark=02" DataIFrameUrlFields="SN"></f:WindowField>

                 <f:RenderField DataField="OutstockQuantity" ColumnID="OutstockQuantity" HeaderText="已出库数">
                </f:RenderField>
                <f:WindowField HeaderText="出库" Icon="ApplicationOsxDelete" WindowID="Window1" DataIFrameUrlFormatString="~/stock/weiwaioutstocknew.aspx?SN={0}&&mark=03" DataIFrameUrlFields="SN"></f:WindowField>
