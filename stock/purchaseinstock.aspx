<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purchaseinstock.aspx.cs" Inherits="AppBoxPro.stock.purchaseinstock" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel CssClass="blockpanel" runat="server" ShowBorder="false" EnableCollapse="false"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    DataKeyNames="SN,PurOrderNo" AllowSorting="true" OnSort="Grid1_Sort" SortField="SN"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="PurPlanNo" SortField="PurPlanNo" Width="150px" HeaderText="采购计划单号" Hidden="true" />
                        <f:TemplateField HeaderText="采购单号" Width="120px" ToolTip="查看采购单明细">
                            <ItemTemplate>
                                <a href="javascript:;" style="color: blue; text-decoration: underline;" onclick="lookOrder('<%#Eval("SN")%>','<%#Eval("PurOrderNo")%>')"><%#Eval("PurOrderNo")%></a>
                            </ItemTemplate>
                        </f:TemplateField>
                        ...
                        <f:BoundField DataField="Quantity" SortField="Quantity" Width="150px" HeaderText="需采购量" />
        ...
        <script>
            function lookOrder(ID, purorderno) {
                parent.addExampleTab({
                    id: 'purchaseinstocklist_' + ID + '_tab',
                    iframeUrl: 'stock/purchaseinstocklist.aspx?sn=' + escape(ID) + '&purorderno=' + escape(purorderno),
                    title: purorderno + '-采购单明细',
                    iconFont: 'sign-in',
            ...
            function lookSaleOrder(ID, saleorderno) {
                parent.addExampleTab({
                    id: 'purchaseinstocklistsale_' + ID + '_tab',
                    iframeUrl: 'stock/purchaseinstocklistsale.aspx?sn=' + escape(ID) + '&saleorderno=' + escape(saleorderno),
                    title: saleorderno + '-销售单 采购明细',
                    iconFont: 'sign-in',
                    refreshWhenExist: true
                });
            }
