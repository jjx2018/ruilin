...
namespace AppBoxPro.AccountMag
{
    public partial class AccountOrderPrice : PageBase
    {
        ...
        private void BindGrid()
        {
            using (var appdb = new AppContext())
            {
                ...
                var qqq = from a in appdb.orderheader
                          ...
                          select new { a.SN,a.FileNo,a.CheckDate,a.Checker,a.ClientCode,a.ClientOrderNo,a.ContainerType,a.Inputer,a.InputerDate,a.IsBom,a.IsCheck,a.IsConfirm,a.LotNo,a.Manager,a.OrderExcel,a.OrderName,a.OrderNo,a.OrderType,a.OutGoodsDate,a.ProductionManager,a.RecOrderDate,a.RecOrderPerson,a.RecOrderPersonID,a.Remark,a.SendOrderDate,c.ChineseName};
        ...
        private void BindGrid2()
        {
            ...
            using (var appdb = new AppContext())
            {
                ...
                var inq = from a in appdb.orderdetail
                          ...
                          from c in userjoin.DefaultIfEmpty()
                          where b.SN == pid
                          select new { a.BomVer,a.ClinetNo,a.Color,a.CountryPackVer,a.Demand1,a.Demand2,a.FSN,a.Inputer,a.IsBom,a.IsChange,a.IsNew,a.IsPackingmaterials,a.ItemName,a.ItemNo,a.OrderNo,a.Price,a.Quantity,a.Remark,a.SN,a.Unit,c.ChineseName,a.InputerDate};
        ...
        protected void Grid1_PreDataBound(object sender, EventArgs e)
        {
            ...
            CheckPowerWithLinkButtonField("OrderAccountCheckDelete", Grid1, "deleteField");
        ...
        protected void Grid2_PreDataBound(object sender, EventArgs e)
        {
            // 数据绑定之前，进行权限检查
            //CheckPowerWithWindowField("InstockEdit", Grid1, "editField");
            CheckPowerWithLinkButtonField("OrderAccountCheckDelete", Grid2, "deleteField");
            //CheckPowerWithWindowField("InstockChangePassword", Grid1, "changePasswordField");
        ...
        protected void btnDeleteSelected2_Click(object sender, EventArgs e)
        {
            ...
            // 在操作之前进行权限检查
            if (!CheckPower("OrderAccountCheckDelete"))
            {
        ...
        protected void Grid2_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "toBOM")
            {
                ...
                iframeUrl: 'BomMag/RealBom.aspx?sn=" + ID + @"&od=" + Grid2.Rows[e.RowIndex].Values[1].ToString() + @"&id=" + Grid2.Rows[e.RowIndex].Values[3].ToString() + @"&q=" + Grid2.Rows[e.RowIndex].Values[6].ToString() + @"',
