<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProduceBom.aspx.cs" Inherits="AppBoxPro.BomMag.ProduceBom" %>
                    ...
                    <Toolbars>
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="请输入料号、名称、规格、分类、主要来源、车间、仓库"
                                    Trigger1Icon="Clear" Trigger2Icon="Search" ShowTrigger1="false" OnTrigger2Click="ttbSearchMessage_Trigger2Click"
                                    OnTrigger1Click="ttbSearchMessage_Trigger1Click" Width="410px">
                                </f:TwinTriggerBox>
