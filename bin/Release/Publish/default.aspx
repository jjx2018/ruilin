<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="AppBoxPro._default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Window ID="Window1" runat="server" IsModal="true" Hidden="false" EnableClose="false"
            ...
            Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPosition="Start" Width="500px">
            <Items>
                
                <f:Image ID="imageLogin" ImageUrl="~/res/images/login/log.png" runat="server"
            ...
            <Toolbars>
                <f:Toolbar runat="server" Position="Bottom">
                    <Items>
                        <f:ToolbarText Text="" runat="server"></f:ToolbarText>
