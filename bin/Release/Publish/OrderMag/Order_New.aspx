<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order_New.aspx.cs" Inherits="AppBoxPro.OrderMag.Order_New" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow runat="server">
                            <Items>
                                 <f:TextBox ID="txtOrderNo" NextFocusControl="txtClinetOrderNo"  runat="server"  EnableBlurEvent="true" OnBlur="txtOrderNo_Blur" ValidateRequestMode="Enabled" RequiredMessage="订单编号不能为空" Label="订单编号" Required="true" FocusOnPageLoad="true" ShowRedStar="true" Text="RL">
                                </f:TextBox>
                    ...
                    <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                              ...
                              <f:TextBox ID="txtContainerType" NextFocusControl="txtOrderType"  LabelWidth="120px"  runat="server" Label="柜型">
                                </f:TextBox>      
