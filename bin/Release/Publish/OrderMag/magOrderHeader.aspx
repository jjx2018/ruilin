<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="magOrderHeader.aspx.cs" Inherits="AppBoxPro.OrderMag.magOrderHeader" %>
...
<body>
       ...
       <f:Panel ID="Panel5" CssClass="blockpanel" runat="server" ShowBorder="false" EnableCollapse="false"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                             ...
                             <f:RadioItem Text="未生成" Value="0"  Selected="true"/>
                    ...
                    ShowRedStar="true">
                        ...
                        <f:Toolbar runat="server">
                          ...
                          <f:Button ID="Button1"  OnClick="btnSave_Click" Hidden="true" runat="server" Icon="SystemSave"    Text="保存">
                            </f:Button> 
                    ...
                    <ItemTemplate>
                        <a href="javascript:;" style="color:blue;text-decoration:underline;" onclick="lookOrder('<%#Eval("SN")%>','<%#Eval("OrderNo")%>')">订单明细</a>
                    </ItemTemplate>
                </f:TemplateField>
               ...
               <f:RenderField Width="80px" TextAlign="Center" ColumnID="ChineseName" DataField="ChineseName"   HeaderText="录单人"  EnableColumnEdit="false">
                    <Editor>
               ...
               <f:RenderField Width="120px" TextAlign="Center" ColumnID="InputerDate" DataField="InputerDate" EnableColumnEdit="false"  Renderer="Date" RendererArgument="yyyy-MM-dd"
                 ...
                 <f:RenderField Width="100px" ColumnID="IsCheck" DataField="IsCheck" EnableColumnEdit="false" FieldType="Int"
                    ...
                    <Editor>
                        ...
                        <f:BoundField DataField="UpdateDate" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" Width="160px" HeaderText="最后更新日期" ></f:BoundField>
                         <f:WindowField ColumnID="editField" HeaderText="编辑" TextAlign="Center" Icon="Pencil" ToolTip="编辑" WindowID="Window2"
                            Title="编辑" DataIFrameUrlFields="SN" DataIFrameUrlFormatString="~/OrderMag/Order_Edit.aspx?id={0}"
                            Width="60px" />
                <f:WindowField ColumnID="checkField" TextAlign="Center" Icon="Key" HeaderText="审核" ToolTip="审核" WindowID="Window2"
                            Title="审核" DataIFrameUrlFields="SN" DataIFrameUrlFormatString="~/OrderMag/checkorder.aspx?id={0}&k=0"
                            Width="60px" />
                <f:WindowField ColumnID="uncheckField" TextAlign="Center" Icon="Key" HeaderText="反审核" ToolTip="反审核" WindowID="Window2"
                            Title="反审核" DataIFrameUrlFields="SN" DataIFrameUrlFormatString="~/OrderMag/checkorder.aspx?id={0}&k=1"
                            Width="80px" />
                <f:LinkButtonField ColumnID="deleteField" TextAlign="Center" HeaderText="删除" Icon="Delete" ToolTip="删除"  
                    ...
                    UrlEncode="true" Target="_blank" ExpandUnusedSpace="true" MinWidth="150px" />
                        <f:BoundField DataField="IsBom"   Width="80px" HeaderText="IsBom" />
    ...
    <script type="text/javascript">
        function lookOrder(ID, orderno) {
            parent.addExampleTab({
                id: 'magOrderDetail_'+ID + '_tab',
                iframeUrl: 'OrderMag/magOrderDetail.aspx?pid=' + escape(ID) + '&od=' + escape(orderno),
                title: orderno+'-订单明细',
                iconFont: 'sign-in',
