<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showNewOrder.aspx.cs" Inherits="AppBoxPro.OrderMag.showNewOrder" %>
       ...
       <f:Panel ID="Panel5" CssClass="blockpanel" runat="server" ShowBorder="false" EnableCollapse="false"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    OnRowCommand="Grid1_RowCommand" OnRowDoubleClick="Grid1_RowDoubleClick" OnPageIndexChange="Grid1_PageIndexChange" >
                    <Toolbars>
                    ...
                    ShowRedStar="true">
                        ...
                        <f:Toolbar runat="server" Position="Bottom" ToolbarAlign="Right">
                            <Items>
                                 <f:Button ID="btnConfirm" Pressed="true"  runat="server" Text="确认" Icon="Application" OnClick="btnConfirm_Click"></f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
                    <PageItems>
