<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Providernew.aspx.cs" Inherits="AppBoxPro.ProviderMag.Providernew" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow runat="server" Hidden="true">
                            <Items>
                                 <f:TextBox ID="tbxClinetNo" runat="server" Label="供应商编号" Required="true" ShowRedStar="true">
                                </f:TextBox>
