<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseCheck.aspx.cs" Inherits="AppBoxPro.Mobile.PurchaseCheck" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true" ID="Panel1" IsFluid="true">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" Title="采购品检" runat="server" HeaderStyle="true">
                </f:Toolbar>
            </Toolbars>
            <Items>
