<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="weiwaiinstock.aspx.cs" Inherits="AppBoxPro.Mobile.weiwaiinstock" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true" ID="Panel1">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" Title="委外进货" runat="server" HeaderStyle="true">
                </f:Toolbar>
            </Toolbars>
            <Items>
