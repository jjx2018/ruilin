<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseInstock.aspx.cs" Inherits="AppBoxPro.Mobile.PurchaseInstock" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true" ID="Panel1" IsFluid="true">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" Title="采购入库" runat="server" HeaderStyle="true">
                </f:Toolbar>
            </Toolbars>
            <Items>
                <f:Grid runat="server" ShowBorder="false" ShowHeader="false" ID="Grid1" Height="150px" AllowCellEditing="true">
                    <Columns>
                        ...
                        <f:RenderField DataField="orderno" HeaderText="采购单号" ColumnID="orderno" Width="180px">
                        </f:RenderField>
                        ...
                        <f:RenderField DataField="targetqut" HeaderText="采购数量" ColumnID="targetqut">
                        </f:RenderField>
                        <f:RenderField DataField="qut" HeaderText="入库数量" ColumnID="qut">
                        </f:RenderField>
                        <f:RenderField DataField="result" HeaderText="品检结果" ColumnID="result" Hidden="true">
                        </f:RenderField>
                ...
                <f:Form runat="server" ShowBorder="false" ShowHeader="false" ID="form2">
                    <Rows>
                        ...
                        <f:FormRow Height="40px" MarginRight="20px">
                            <Items>
                                <f:TextBox runat="server" Label="采购单号" ID="tbxprosn" LabelWidth="100px" Required="true"></f:TextBox>
                        ...
                        <f:FormRow Height="40px" MarginRight="20px">
                            <Items>
                                <f:NumberBox runat="server" Label="采购数" LabelWidth="80px" Required="true" NoNegative="true" ID="nbPurQut" Readonly="true"></f:NumberBox>
    ...
    <script>
        ...
        var storagename = 'purchaseinstock';
