<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="magProduceOrderHeader.aspx.cs" Inherits="AppBoxPro.ProduceMag.magProduceOrderHeader" %>
       ...
       <f:Panel ID="Panel5" CssClass="blockpanel" runat="server" ShowBorder="false" EnableCollapse="false"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    OnRowCommand="Grid1_RowCommand" OnPageIndexChange="Grid1_PageIndexChange"  OnRowDoubleClick="Grid1_RowDoubleClick" EnableRowDoubleClickEvent="true">
                    <Toolbars>
                        ...
                        <f:Toolbar runat="server">
                            <Items>
                                <f:Button ID="btnPrint"   OnClick="btnPrint_Click" ValidateMessageBox="false"  ValidateForms="SimpleForm1"  runat="server" Icon="Disk"  Text="打印领料单">
                                </f:Button>
                    ...
                    <ItemTemplate>
                        <a href="javascript:;" style="color:blue;text-decoration:underline;" onclick="lookOrder('<%#Eval("SN")%>','<%#Eval("ProOrderNo")%>')">查看明细</a>
                    </ItemTemplate>
                </f:TemplateField>
                        <f:BoundField ColumnID="ProPlanNo"  DataField="ProPlanNo" SortField="ProPlanNo" Width="150px" HeaderText="生产计划单号" />
                        <f:BoundField ColumnID="ProOrderNo"  DataField="ProOrderNo" SortField="ProOrderNo" Width="150px" HeaderText="生产单号" />
                        ...
                        <f:BoundField ColumnID="WorkShop"  DataField="WorkShop"   Width="150px" HeaderText="生产车间" />
...
<script type="text/javascript">
        function lookOrder(ID, orderno) {
            parent.addExampleTab({
                id: 'magProduceOrderDetail'+ID + '_tab',
                iframeUrl: 'ProduceMag/magProduceOrderDetail.aspx?pid=' + escape(ID) + '&od=' + escape(orderno),
                title: orderno+'-明细',
                iconFont: 'sign-in',
