<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductInStockListSale.aspx.cs" Inherits="AppBoxPro.product.ProductInStockListSale" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
            ...
            <Columns>
                ...
                <f:BoundField DataField="ProPlanNo" SortField="ProPlanNo" Width="130px" HeaderText="生产计划单号" Hidden="true" />
                ...
                <f:BoundField DataField="Quantity" ColumnID="Quantity" SortField="Quantity" Width="90px" HeaderText="应生产数量" />
                <f:RenderField DataField="InstockQuantity" ColumnID="InstockQuantity" HeaderText="入库数">
                </f:RenderField>
                <f:WindowField HeaderText="入库" Icon="ApplicationOsxAdd" WindowID="Window1" DataIFrameUrlFormatString="~/stock/purchaseinstocknew.aspx?SN={0}" DataIFrameUrlFields="SN" Hidden="true"></f:WindowField>
