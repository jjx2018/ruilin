<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purchaseinstocknew.aspx.cs" Inherits="AppBoxPro.stock.purchaseinstocknew" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid runat="server" ID="Grid1" OnRowCommand="Grid1_RowCommand" DataKeyNames="SN" Title="入库记录">
            <Toolbars>
            ...
            <Columns>
                <f:BoundField DataField="PurOrderNo" HeaderText="采购单号" Width="150px"></f:BoundField>
                ...
                <f:BoundField DataField="Unit" HeaderText="单位"></f:BoundField>
                 <f:BoundField DataField="Remark" HeaderText="备注"></f:BoundField>
