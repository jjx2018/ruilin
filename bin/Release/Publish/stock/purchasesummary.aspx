<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purchasesummary.aspx.cs" Inherits="AppBoxPro.stock.purchasesummary" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Grid runat="server" ID="Grid1" IsDatabasePaging="false" SortField="" AllowPaging="true"  ShowHeader="false">
            ...
            <Columns>
                ...
                <f:WindowField HeaderText="入库" TextAlign="Center" IconFont="ArrowCircleODown" ToolTip="入库"
                            WindowID="Window1" Title="待入库清单" DataIFrameUrlFields="PurPlanNo" DataIFrameUrlFormatString="~/stock/instockpurchase_new.aspx?PurOrderNo={0}"
                            Width="60px" />
        ...
        <f:Window ID="Window1" runat="server" IsModal="true" Hidden="true" Target="Top" EnableResize="true"
            ...
            Width="1100px" Height="600px" OnClose="Window1_Close">
        </f:Window>
    </form>
</body>
</html>
