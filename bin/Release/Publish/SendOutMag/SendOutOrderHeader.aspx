<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendOutOrderHeader.aspx.cs" Inherits="AppBoxPro.SendOutMag.SendOutOrderHeader" %>
       ...
       <f:Panel ID="Panel5" CssClass="blockpanel" runat="server" ShowBorder="false" EnableCollapse="false"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    OnRowCommand="Grid1_RowCommand" OnPageIndexChange="Grid1_PageIndexChange"  EnableRowClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick" EnableRowDoubleClickEvent="true">
                    <Toolbars>
                            ...
                            <Items>
                                ...
                                <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="请输入料号或名称或规格"
                                    ...
                                    OnTrigger1Click="ttbSearchMessage_Trigger1Click" Width="300px">
                                         ...
                                         <f:DatePicker ID="datePickerFrom" DateFormatString="yyyy-MM-dd" LabelWidth="80px"  Width="200px"    runat="server" Label="开始"></f:DatePicker>
                                <f:DatePicker ID="datePickerTo" DateFormatString="yyyy-MM-dd" LabelWidth="80px"  Width="200px"    runat="server" Label="结束"  CompareControl="datePickerFrom" CompareOperator="GreaterThan" CompareMessage="结束日期应大于开始日期"></f:DatePicker>
                        ...
                        <f:Toolbar runat="server">
                            <Items>
                                <f:Button ID="btnPrint"   OnClick="btnPrint_Click" ValidateMessageBox="false"  ValidateForms="SimpleForm1"  runat="server" Icon="Disk"  Text="打印委外单">
                                </f:Button>
                                
                                 <f:NumberBox runat="server" ID="numLabCount" Width="200px" MinValue="1" Text="1" Label="标签份数"></f:NumberBox>
                                 <f:Button ID="btnPrintLab"   OnClick="btnPrintLab_Click" ValidateMessageBox="false"  ValidateForms="SimpleForm1"  runat="server" Icon="Disk"  Text="打印生产单标签">
                                </f:Button>
                    ...
                    <ItemTemplate>
                        <a href="javascript:;" style="color:blue;text-decoration:underline;" onclick="lookOrder('<%#Eval("SN")%>','<%#Eval("SendOutOrderNo")%>')">查看明细</a>
                    </ItemTemplate>
                </f:TemplateField>
                        <f:BoundField ColumnID="SendOutPlanNo" DataField="SendOutPlanNo" SortField="SendOutPlanNo" Width="150px" HeaderText="委外计划号" />
                        <f:BoundField ColumnID="SendOutOrderNo"  DataField="SendOutOrderNo" SortField="SendOutOrderNo" Width="150px" HeaderText="委外单号" />
                        <f:BoundField ColumnID="SaleOrderNo"  DataField="SaleOrderNo" SortField="SaleOrderNo" Width="150px" HeaderText="销售单号" />
                        <f:BoundField ColumnID="SendOutDate"  DataField="SendOutDate" SortField="PurDate" Width="150px" HeaderText="下单日期" />
                        <f:BoundField ColumnID="Provider"  DataField="Provider" ExpandUnusedSpace="true"  Width="200px" HeaderText="供应商" />
                        <f:BoundField ColumnID="JBRName"  DataField="JBRName"   Width="150px" HeaderText="经办人" />
 ...
 <script type="text/javascript">
        function lookOrder(ID, orderno) {
            parent.addExampleTab({
                id: 'SendOutOrderDetail_'+ID + '_tab',
                iframeUrl: 'SendOutMag/SendOutOrderDetail.aspx?pid=' + escape(ID) + '&od=' + escape(orderno),
                title: orderno+'-订单明细',
                iconFont: 'sign-in',
