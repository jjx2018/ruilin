<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendOutOrderSearch.aspx.cs" Inherits="AppBoxPro.SendOutMag.SendOutOrderSearch" %>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Columns>
                       <f:RowNumberField Width="30px" EnablePagingNumber="true" />
                        <f:BoundField DataField="SendOutPlanNo" SortField="SendOutPlanNo" Width="150px" HeaderText="委外计划号" />
                        ...
                        <f:BoundField DataField="SendOutDate" SortField="PurDate" Width="150px" HeaderText="下单日期" />
                        <f:BoundField DataField="Provider" ExpandUnusedSpace="true"  Width="200px" HeaderText="供应商" />
                        <f:BoundField DataField="JBRName"   Width="150px" HeaderText="经办人" />
                ...
                <f:Panel ID="Panel4" Title="产品信息" BoxFlex="1" MinHeight="270px" Margin="0"
                  ...
                  <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="ItemNo" SortField="ItemNo" Width="130px" HeaderText="料号" />
