    ...
    public partial class SendInstruction : PageBase
    {
        ...
        private bool SaveItem()
        {
            ...
            using (var appdb = new AppContext())
            {
                ...
                item.IsPlan = 0;
                item.BomSN = bomsn;
                item.OdtSN = GetQueryIntValue("odtsn");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string scripts = String.Format("F.getActiveWindow().window.__doPostBack('','updaterowcss:"+GetQueryValue("ridx")+"');");
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (SaveItem())
                {
                    string scripts = String.Format("F.getActiveWindow().window.__doPostBack('','updaterowcss:" + GetQueryValue("ridx") + "');");
                    //PageContext.RegisterStartupScript(scripts);
                    PageContext.RegisterStartupScript(Alert.GetShowInTopReference("保存成功") + scripts+ ActiveWindow.GetHideReference() );
                }
                else
                {
