<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="magInstructionDetail.aspx.cs" Inherits="AppBoxPro.StoreConfirm.magInstructionDetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" IsFluid="true" CssClass="blockpanel" ShowBorder="true" ShowHeader="false" Title="" EnableCollapse="false"
            ...
            DataIDField="SN" EnableCheckBoxSelect="true"  KeepCurrentSelection="false" OnPageIndexChange="Grid1_PageIndexChange"  AllowSorting="true" OnSort="Grid1_Sort"  SortField="SN" OnRowCommand="Grid1_RowCommand"  EnterNavigate="true" TabVerticalNavigate="false" EnterVerticalNavigate="true"
            ...
            <Toolbars>
                ...
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        <f:Button ID="btnNew"   Text="新增" Hidden="true" Icon="Add" EnablePostBack="false" runat="server">
                         ...
                         <f:Button ID="btnSaveSel"  OnClick="btnSaveSel_Click" runat="server" Icon="SystemSave"    Text="零备货确认">
                            </f:Button> 
                ...
                <f:Toolbar runat="server">
                    <Items>
                        <f:Label ID="labOrderno" LabelWidth="70px" Width="200px" runat="server" Label="订单号"></f:Label>
                        <f:Label ID="labProno" LabelWidth="70px"  Width="200px" runat="server" Label="产品号"></f:Label>
                        <f:Label ID="labProname" LabelWidth="90px"  Width="300px" runat="server" Label="产品名称"></f:Label>
                    </Items>
                </f:Toolbar>
            </Toolbars>
                                <PageItems>
            ...
            <Columns>
                <f:RowNumberField />
                  <f:RenderField Width="150px" Hidden="true" ColumnID="OrderNo" DataField="OrderNo"
                  ...
                  <f:RenderField Width="150px" Hidden="true" ColumnID="ProNo" DataField="ProNo" EnableColumnEdit="false"
                      HeaderText="产品编号">
                    <Editor>
                  ...
                  <f:RenderField Width="150px"  Hidden="true" ColumnID="ProName" DataField="ProName" EnableColumnEdit="false"
                      HeaderText="产品名称">
                    <Editor>
               ...
               <f:LinkButtonField ColumnID="deleteField" TextAlign="Center" Icon="Delete" ToolTip="删除" ConfirmText="确定删除此记录？"
                ...
                <f:BoundField Hidden="false" DataField="OdtSN"  HeaderText="OdtSN" />
            </Columns>
             <Listeners>
