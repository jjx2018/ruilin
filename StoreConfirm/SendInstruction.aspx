<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendInstruction.aspx.cs" Inherits="AppBoxPro.StoreConfirm.SendInstruction" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow runat="server">
                            <Items>
                                 <f:TextBox ID="txtOrderNo" Readonly="true" runat="server" Label="订单编号" Required="true" >
                                </f:TextBox>
                        ...
                        <f:FormRow runat="server">
                            <Items>
                              <f:TextBox ID="txtProNo" AutoPostBack="false" runat="server" Label="产品编号" Required="true"  >
                                </f:TextBox>
                              
                                <f:TextBox ID="txtProName" runat="server" Label="产品名称" Required="true"   >
                                </f:TextBox>
                         ...
                         <f:FormRow runat="server">
                            <Items>
                              <f:TextBox ID="txtItemNo" AutoPostBack="false" runat="server" Label="料号" Required="true"  >
                                </f:TextBox>
                              
                                <f:TextBox ID="txtItemName" runat="server" Label="名称" Required="true"   >
                                </f:TextBox>
                     ...
                     <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                 <f:TextBox ID="txtMakeThod"  runat="server" Label="生产方式">
                                </f:TextBox>  
                                 <f:TextBox ID="txtStock"  runat="server" Label="参考库存">
                                </f:TextBox>     
                                </Items>
                         </f:FormRow>
                    <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                              <f:NumberBox ID="txtUsingQuantity" MinValue="1"  runat="server" Label="理论用量">
                                </f:NumberBox>  
                               
                                    <f:NumberBox ID="txtQuantity" FocusOnPageLoad="true" MinValue="1" runat="server" Label="备货数量">
                                </f:NumberBox>                            
                            </Items>
                        </f:FormRow>
                        ...
                        <f:Toolbar ID="Toolbar2" runat="server">
                            <Items>
                                ...
                                <f:RadioButtonList AutoPostBack="true" OnSelectedIndexChanged="rbtDept_SelectedIndexChanged" runat="server" ID="rbtDept">
                                    <f:RadioItem Text="仓库" Value="仓库" Selected="true" />
