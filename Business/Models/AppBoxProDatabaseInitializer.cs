...
namespace AppBoxPro
{
    public class AppBoxProDatabaseInitializer : DropCreateDatabaseIfModelChanges<AppBoxProContext>  // DropCreateDatabaseAlways<AppBoxProContext>  DropCreateDatabaseIfModelChanges<AppBoxProContext>
    {
        protected override void Seed(AppBoxProContext context)
        {
        ...
        private static List<Menu> GetMenus(AppBoxProContext context)
        {
        ...
        private static List<Config> GetConfigs()
        {
            var configs = new List<Config> {
                ...
                {
                    ConfigKey = "Title",
                    ConfigValue = "通用权限管理框架（AppBoxPro）",
                    Remark = "网站的标题"
                },
                new Config
                {
