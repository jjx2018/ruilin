<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="magInstruction.aspx.cs" Inherits="AppBoxPro.StoreConfirm.magInstruction" %>
                ...
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        <f:Button ID="btnNew"   Text="新增" Hidden="true" Icon="Add" EnablePostBack="false" runat="server">
                         ...
                         <f:Button ID="btnSaveSel"  OnClick="btnSaveSel_Click" runat="server" Icon="SystemSave"    Text="保存选中">
                            </f:Button> 
