<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="themes.aspx.cs" Inherits="AppBoxPro.admin.themes" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="themecontainer">
            ...
            <ul>
                <li>
                    <a href="javascript:;">
                        <img src="../res/images/themes/small/customtheme.png" alt="Custom Default" data-value="custom_default" /></a>
                    <div class="title">Custom Default</div>
                </li>
                <li>
                    <a href="javascript:;">
                        <img src="../res/images/themes/small/customtheme.png" alt="Bootstrap Pure" data-value="bootstrap_pure" /></a>
                    <div class="title">Bootstrap Pure</div>
                </li>
                <li>
                    <a href="javascript:;">
                        <img src="../res/images/themes/small/customtheme.png" alt="Custom Light Green" data-value="custom_light_green" /></a>
    ...
    <script>
        F.ready(function () {
            ...
            $('#themecontainer li').hover(function () {
                ...
                activeWindow.window.returnFromThemeWindow(themeName);
                activeWindow.hide();
            });


            // 初始化
            var themeName = F.queryString('selected');
            if (!themeName) {
                themeName = 'cupertino';
            }
