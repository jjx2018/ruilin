<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menu.aspx.cs" Inherits="AppBoxPro.admin.menu" %>
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="ViewPower.Name" HeaderText="浏览权限" Width="150px" />
