<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="ProduceBomDetail.aspx.cs" Inherits="AppBoxPro.BomMag.ProduceBomDetail" %>
...
<f:Grid ID="Grid2" BoxFlex="1" CssClass="blockpanel" ShowBorder="true" ShowHeader="false" Title="" EnableCollapse="false"
            runat="server" DataKeyNames="SN" AllowCellEditing="true" ClicksToEdit="1"  EnableTextSelection="true" 
             EnableCheckBoxSelect="true"  KeepCurrentSelection="false" OnPageIndexChange="Grid2_PageIndexChange"  AllowSorting="true" OnSort="Grid2_Sort"  SortField="SN" OnRowCommand="Grid2_RowCommand"  EnterNavigate="true" TabVerticalNavigate="false" EnterVerticalNavigate="true"
                    SortDirection="DESC" AllowPaging="true" IsDatabasePaging="true" OnRowDataBound="Grid2_RowDataBound" EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid2_RowDoubleClick" EnableTree="false" TreeColumn="ItemNo" DataIDField="SUBSN" DataParentIDField="ParentSN"  EnableTreeIcons="false"  ExpandAllTreeNodes="true">
                    ...
                    <Toolbars>
                        ...
                        <f:TextBox ID="txtClickColsName" runat="server" Hidden="true" Label="列名" LabelWidth="50px"></f:TextBox>
                               <f:Button ID="btnCopy" Pressed="true" Enabled="true"  runat="server" Text="复制" Icon="PageCopy" OnClick="btnCopy_Click"></f:Button>
                                
                               <f:Button ID="btnNew" OnClick="btnNew_Click"  Pressed="true" Enabled="true"  Text="新增" Icon="Add" runat="server">
                        </f:Button>
                                 <f:Button ID="btnZUHE" OnClick="btnZUHE_Click" Pressed="true" Enabled="true"  Text="添加组合件" Icon="Add" runat="server">
                        </f:Button>
                          <f:Button ID="btnSave"  OnClick="btnSave_Click"  Pressed="true" Enabled="true" runat="server" Icon="SystemSave"    Text="保存">
                            </f:Button> 
                        <f:Button ID="btnDelete" Hidden="false"  Pressed="true" Enabled="true" OnClick="btnDeleteSelected_Click" Text="删除" Icon="Delete"  runat="server">
                        </f:Button>
                                <f:DropDownList ID="ddlDept" Label="接收部门" EmptyText="请选择" EnableEdit="true" LabelWidth="80px" Width="220px" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged" AutoPostBack="true" AutoSelectFirstItem="false" runat="server">

                                </f:DropDownList>
                                <f:DropDownList ID="ddlUser" Label="接收人" EnableEdit="true"  EmptyText="请选择" LabelWidth="70px" Width="160px"  runat="server">

                                </f:DropDownList>
                          <f:Button ID="btnPLSend" Hidden="false"  Pressed="true" Enabled="true" OnClick="btnPLSend_Click" Text="批量发送确认单" Icon="PageWhiteStack"  runat="server">
                        </f:Button>      
                    ...
                    <Editor>
                        <f:TextBox ID="TextBox6" Required="true" runat="server">
                         ...
                         <f:WindowField ColumnID="remark" TextAlign="Center" Icon="ApplicationAdd" HeaderText="添加备注" DataToolTipField="Remark" WindowID="Window2"
                            ...
                            Width="80px" />
                        <f:RenderField Width="100px" ColumnID="IsValid" DataField="IsValid" SortField="IsValid"
                      HeaderText="是否有效" RendererFunction="renderIsValid" >
                     
                    <Editor>
                         <f:DropDownList Required="false" runat="server"  EnableEdit="true"  ID="DropDownList1">
                            <f:ListItem Value="0" Text="有效" />
                            <f:ListItem Value="1" Text="无效" />
