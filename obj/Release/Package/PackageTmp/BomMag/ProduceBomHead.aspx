<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProduceBomHead.aspx.cs" Inherits="AppBoxPro.BomMag.ProduceBomHead" %>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Columns>
                        <f:RowNumberField Width="30px" ColumnID="bfRowNum" TextAlign="Center" EnablePagingNumber="true" />
                         <f:TemplateField HeaderText="BOM明细" Width="80px" ToolTip="查看BOM明细">
                    <ItemTemplate>
                        <a href="javascript:;" style="color:blue;text-decoration:underline;" onclick="lookOrder('<%#Eval("SN")%>','<%#Eval("ProNo")%>','<%#Eval("ProName")%>','<%#Eval("OrderNo")%>')">BOM明细</a>
                    </ItemTemplate>
                </f:TemplateField>
                        <f:BoundField ColumnID="OrderNo"  DataField="OrderNo" TextAlign="Center" SortField="OrderNo" Width="110px" HeaderText="订单编号" />
                        <f:BoundField ColumnID="ClinetNo"  DataField="ClinetNo" TextAlign="Center"   Width="100px" HeaderText="客人编号" />
                        <f:BoundField ColumnID="ProNo"  DataField="ProNo" TextAlign="Center" SortField="ProNo"   Width="120px" HeaderText="型号" />
                        <f:BoundField ColumnID="ProName"  DataField="ProName" TextAlign="Center" SortField="ProName"   Width="200px" HeaderText="产品名称" />    
                        ...
                        <f:BoundField ColumnID="Quantity"  DataField="Quantity" TextAlign="Center" SortField="Quantity" Width="100px" HeaderText="数量" />
                         <f:BoundField ColumnID="Ver"   DataField="Ver" TextAlign="Center" Width="90px" HeaderText="BOM版本" />
                        <f:BoundField  ColumnID="ChineseName"  DataField="ChineseName" TextAlign="Center" Width="90px" HeaderText="录入人" />
                        ...
                        <%-- <f:BoundField Hidden="true" DataField="Color"  ExpandUnusedSpace="true"  HeaderText="颜色" />
                         ...
                         <f:WindowField ColumnID="viewField" HeaderText="详情" TextAlign="Center" Icon="ApplicationViewIcons" ToolTip="查看订单详情" WindowID="Window1"
                            Title="查看订单详情" DataIFrameUrlFields="OdtSN" DataIFrameUrlFormatString="~/OrderMag/OrderDetailedit.aspx?id={0}&k=1"
                            Width="60px" />
...
<script>
    ...
    function lookOrder(ID,itemno,itemname, orderno) {
        parent.addExampleTab({
            ...
            iframeUrl: 'BomMag/ProduceBomDetail.aspx?ProNo=' + escape(itemno) + '&od=' + escape(orderno) + '&ItemName=' + escape(itemname)+'&sn='+ID,
