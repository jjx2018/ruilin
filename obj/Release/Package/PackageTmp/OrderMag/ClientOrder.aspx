<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientOrder.aspx.cs" Inherits="AppBoxPro.OrderMag.ClientOrder" %>
       ...
       <f:Panel ID="Panel5" CssClass="blockpanel" runat="server" ShowBorder="false" EnableCollapse="false"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    OnPreRowDataBound="Grid1_PreRowDataBound" AllowCellEditing="true" ClicksToEdit="2" EnableTextSelection="true" KeepCurrentSelection="false"
               ...
               <f:RenderField Width="120px" TextAlign="Center"  ColumnID="SendOrderDate" DataField="SendOrderDate"  Renderer="Date" RendererArgument="yyyy-MM-dd"
                      HeaderText="发单日期">
                    <Editor>
                        <f:DatePicker ID="txtSendOrderDate" Required="true" runat="server">
                        </f:DatePicker>
                    </Editor>
                </f:RenderField>
               ...
               <f:RenderField Width="80px" TextAlign="Center" ColumnID="Inputer" DataField="Inputer"   HeaderText="录单人"  EnableColumnEdit="false">
                    <Editor>
                          <f:TextBox ID="txtInputer" Required="true" runat="server">
                        </f:TextBox>
                    </Editor>
                </f:RenderField> 
               <f:RenderField Width="120px" TextAlign="Center" ColumnID="InputerDate" DataField="InputerDate" EnableColumnEdit="false"  Renderer="Date" RendererArgument="yyyy-MM-dd"
                ...
                <f:LinkButtonField ColumnID="deleteField" TextAlign="Center" HeaderText="删除" Icon="Delete" ToolTip="删除"  
                            ConfirmText="确定删除此记录？" ConfirmTarget="Top" CommandName="Delete" Width="60px" Hidden="true" />
                  ...
                  <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Editor>
                        ...
                        <f:BoundField  DataField="Inputer" TextAlign="Center" Width="80px" HeaderText="录入人" />
                         <f:BoundField DataField="Remark"    Width="300px" HeaderText="备注" />
                        <f:TemplateField HeaderText="生成BOM" Width="100px" ToolTip="生成BOM" Hidden="true">
                    <ItemTemplate>
