<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDetailNew.aspx.cs" Inherits="AppBoxPro.OrderMag.OrderDetailNew" %>
...
<body>
    <div id="msgdiv" style="z-index:99999;top:50%;left:50%;width:200px; height:50px;color:red;font-weight:bolder;font-size:30px;display:none;">保存成功</div>
    <form id="form1" runat="server">
                    ...
                    <Rows>
                        <f:FormRow runat="server">
                            <Items>
                                ...
                                <f:TextBox ID="txtClinetNo" NextFocusControl="txtItemNo"  runat="server" Readonly="true" Label="客人代码" Required="true" ShowRedStar="true">
                                </f:TextBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow runat="server">
                            <Items>
                              <f:TextBox ID="txtItemNo" NextFocusControl="txtItemName" AutoPostBack="true" FocusOnPageLoad="true" LabelWidth="130px" Width="400px"  runat="server" Label="型号" OnBlur="txtItemNo_Blur" Required="true" OnTextChanged="txtItemNo_TextChanged" ShowRedStar="true">
                                </f:TextBox>
                       ...
                       <f:FormRow runat="server" ID="searchRow" Hidden="true">
                         ...
                         <f:FormRow ID="FormRow7" runat="server">
                            <Items>
                                 <f:NumberBox ID="txtQuantity" Required="true" RequiredMessage="数量不能为空" ShowRedStar="true" NextFocusControl="txtUnit" runat="server" LabelWidth="130px" Width="400px"  Label="数量">
                                </f:NumberBox>
       ...
       <f:Window ID="Window1" Title=""  EnableIFrame="true" runat="server" Hidden="true" 
            EnableMaximize="false" EnableResize="false"   ShowHeader="true"  Target="Self" IsModal="false" Width="700px"
