<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendOutPlanSearch.aspx.cs" Inherits="AppBoxPro.SendOutMag.SendOutPlanSearch" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    OnPageIndexChange="Grid1_PageIndexChange" OnRowDataBound="Grid1_RowDataBound"  KeepCurrentSelection="true" OnRowDoubleClick="Grid1_RowDoubleClick" EnableRowDoubleClickEvent="true" >
                    <Toolbars>
                    ...
                    <Columns>
                     <f:RowNumberField Width="30px" EnablePagingNumber="true" />
                        <f:BoundField ColumnID="SendOutPlanNo"  DataField="SendOutPlanNo" SortField="ProPlanNo" Width="150px" HeaderText="委外计划号" />
                        <f:BoundField ColumnID="Provider"  DataField="Provider"   Width="150px" HeaderText="委外厂家" />
                        <f:BoundField ColumnID="ProviderID"  DataField="ProviderID" Hidden="true" Width="150px" HeaderText="委外厂家" />
                        ...
                        <f:BoundField ColumnID="Spec"  DataField="Spec" SortField="Spec" MinWidth="50px" ExpandUnusedSpace="true" HeaderText="规格" />
                        <f:BoundField ColumnID="Quantity"  DataField="Quantity" SortField="Quantity" Width="100px" HeaderText="委外数量" />
                        <f:BoundField ColumnID="WorkShop"  DataField="WorkShop" SortField="WorkShop" Width="120px" HeaderText="所属车间" />
