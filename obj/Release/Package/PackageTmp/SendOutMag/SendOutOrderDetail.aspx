<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendOutOrderDetail.aspx.cs" Inherits="AppBoxPro.SendOutMag.SendOutOrderDetail" %>
       ...
       <f:Panel ID="Panel5" CssClass="blockpanel" runat="server" ShowBorder="false" EnableCollapse="false"
            ...
            <Items>
                ...
                <tr>
                    ...
                    <td style="font-weight: normal;width:7%;"><%=plan %></td>
                    <td style="width:6%;border:0px solid #000;">客供单号：</td>
                    <td style="font-weight: normal;width:5%;"><%=orderno %></td>
                    ...
                    <Columns>
                        ...
                        <f:BoundField Hidden="true" DataField="SendOutPlanNo" SortField="SendOutPlanNo" Width="150px" HeaderText="委外计划单号" />
                        <f:BoundField Hidden="true" DataField="SendOutOrderNo" SortField="SendOutOrderNo" Width="150px" HeaderText="委外单号" />
                        <f:BoundField Hidden="true" DataField="SaleOrderNo" SortField="SaleOrderNo" Width="150px" HeaderText="销售单号" />
                        ...
                        <f:BoundField ColumnID="ItemNo"  DataField="ItemNo" SortField="ItemNo" Width="130px" HeaderText="料号" />
                        ...
                        <f:BoundField ColumnID="BarCode"  DataField="BarCode"   Width="150px" HeaderText="条码" />
