<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="weiwaioutstock.aspx.cs" Inherits="AppBoxPro.Mobile.weiwaioutstock" %>
...
<body>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true" ID="Panel1">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" Title="委外出货" runat="server" HeaderStyle="true">
                </f:Toolbar>
            </Toolbars>
            <Items>
                <f:Grid runat="server" ShowBorder="false" ShowHeader="false" ID="Grid1" Height="150px" AllowCellEditing="true">
                    <Columns>
                        ...
                        <f:RenderField DataField="barcode" HeaderText="条码号" ColumnID="barcode"></f:RenderField>
                        <f:RenderField DataField="orderno" HeaderText="委外单号" ColumnID="orderno">
                        </f:RenderField>
                        ...
                        <f:RenderField DataField="targetqut" HeaderText="委外数量" ColumnID="targetqut">
                        </f:RenderField>
                        <f:RenderField DataField="qut" HeaderText="出库数量" ColumnID="qut">
                        </f:RenderField>
                ...
                <f:Form runat="server" ShowBorder="false" ShowHeader="false" ID="form2">
                    <Rows>
                        ...
                        <f:FormRow Height="40px" MarginRight="20px">
                            <Items>
                                <f:TextBox runat="server" Label="委外单号" ID="tbxprosn" LabelWidth="100px" Required="true"></f:TextBox>
                        ...
                        <f:FormRow Height="40px" MarginRight="20px">
                            <Items>
                                <f:NumberBox runat="server" Label="出库数" LabelWidth="80px" Required="true" NoNegative="true" ID="nbQut"></f:NumberBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow Height="40px" MarginRight="20px">
                            <Items>
                                <f:NumberBox runat="server" Label="委外数" LabelWidth="80px" Required="true" NoNegative="true" ID="nbPurQut" Readonly="true"></f:NumberBox>
