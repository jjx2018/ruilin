<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="magProduceOrder.aspx.cs" Inherits="AppBoxPro.ProduceMag.magProduceOrder" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Columns>
                       <f:RowNumberField Width="30px" EnablePagingNumber="true" />
                        ...
                        <f:BoundField DataField="Quantity" SortField="Quantity" Width="90px" HeaderText="生产数量" />
                ...
                <f:Panel ID="Panel4" Title="产品信息" BoxFlex="1" MinHeight="270px" Margin="0"
                  ...
                  <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Columns>
                        <f:RowNumberField Width="30px" EnablePagingNumber="true" />
                        <f:BoundField DataField="ProPlanNo" SortField="ProPlanNo" Width="130px" HeaderText="生产计划单号" />
                        <f:BoundField DataField="ProOrderNo" SortField="ProOrderNo" Width="150px" HeaderText="生产单号" />
                        <f:BoundField DataField="SaleOrderNo" SortField="SaleOrderNo" Width="140px" HeaderText="销售单号" />
                        <f:BoundField DataField="ProNo" SortField="ProNo" Width="110px" HeaderText="品号" />
                        <f:BoundField DataField="ProName" SortField="ProName" Width="100px" HeaderText="品名" />
                        ...
                        <f:BoundField DataField="Spec" SortField="Spec" ExpandUnusedSpace="true" HeaderText="规格" />
                        <f:BoundField DataField="Quantity" SortField="Quantity" Width="90px" HeaderText="生产数量" />
                        <f:BoundField DataField="WorkShop"   Width="110px" HeaderText="生产车间" />
