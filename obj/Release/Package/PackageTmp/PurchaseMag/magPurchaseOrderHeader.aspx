<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="magPurchaseOrderHeader.aspx.cs" Inherits="AppBoxPro.PurchaseMag.magPurchaseOrderHeader" %>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Toolbars>
                        ...
                        <f:Toolbar runat="server">
                            <Items>
                                <f:Button ID="btnPrint"   OnClick="btnPrint_Click" ValidateMessageBox="false"  ValidateForms="SimpleForm1"  runat="server" Icon="Disk"  Text="打印采购单">
                                </f:Button>
                                        <f:NumberBox runat="server" Hidden="true" ID="numLabCount" Width="200px" MinValue="1" Text="1" Label="标签份数"></f:NumberBox>
                                <f:Button ID="btnPrintLab"   OnClick="btnPrintLab_Click" ValidateMessageBox="false"  ValidateForms="SimpleForm1"  runat="server" Icon="Disk"  Text="打印采购单标签">
                                </f:Button>
                    ...
                    <ItemTemplate>
                        <a href="javascript:;" style="color:blue;text-decoration:underline;" onclick="lookOrder('<%#Eval("SN")%>','<%#Eval("PurOrderNo")%>')">查看明细</a>
                    </ItemTemplate>
                </f:TemplateField>
                        <f:BoundField ColumnID="PurPlanNo"  DataField="PurPlanNo" SortField="PurPlanNo" Width="150px" HeaderText="采购计划单号" />
                        <f:BoundField ColumnID="PurOrderNo"  DataField="PurOrderNo" SortField="PurOrderNo" Width="150px" HeaderText="采购单号" />
                        <f:BoundField ColumnID="SaleOrderNo"  DataField="SaleOrderNo" SortField="SaleOrderNo" Width="150px" HeaderText="销售单号" />
                        <f:BoundField ColumnID="PurDate"  DataField="PurDate" SortField="PurDate" Width="150px" DataFormatString="{0:yyyy-MM-dd}"  HeaderText="下单日期" />
...
<script type="text/javascript">
        function lookOrder(ID, orderno) {
            parent.addExampleTab({
                id: 'magPurchaseOrderDetail'+ID + '_tab',
                iframeUrl: 'PurchaseMag/magPurchaseOrderDetail.aspx?pid=' + escape(ID) + '&od=' + escape(orderno),
                title: orderno+'-明细',
                iconFont: 'sign-in',
