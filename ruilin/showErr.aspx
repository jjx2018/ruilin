<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showErr.aspx.cs" Inherits="AppBoxPro.ruilin.showErr" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="true" Title="料号不规范的物料"
                   ...
                   <Toolbars>
                    ...
                    <Columns>
                                                ...
                                                <f:BoundField DataField="Seq"  Width="50px" HeaderText="序号" />
