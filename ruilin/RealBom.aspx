<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealBom.aspx.cs" Inherits="AppBoxPro.ruilin.RealBom" %>
                ...
                <f:Toolbar ID="Toolbar1" runat="server" Hidden="false">
                    <Items>
                        ...
                        <f:Button ID="btnSaveForm" ValidateForms="SimpleForm1" Icon="SystemSaveClose" OnClick="btnSaveForm_Click"
                         ...
                         <f:DropDownList ID="ddlBOM" Width="200px" Label="BOM版本" Required="true" runat="server">
                        </f:DropDownList>
                ...
                <f:Panel ID="Panel10" ShowBorder="true" Margin="0px" ShowHeader="false" BoxFlex="1" Layout="Fit" runat="server">
                  ...
                  <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    DataKeyNames="SN" AllowSorting="true"    SortField="SN" OnSort="Grid1_Sort"
                      AllowPaging="false" IsDatabasePaging="true" OnPageIndexChange="Grid1_PageIndexChange" OnRowCommand="Grid1_RowCommand" EnterSameAsTab="true" EnableTree="true" TreeColumn="ItemNo" DataIDField="SUBSN" DataParentIDField="ParentSN"  EnableTreeIcons="false" ExpandAllTreeNodes="true">
                    <Toolbars>
