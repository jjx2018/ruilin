<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="magProduceOrder.aspx.cs" Inherits="AppBoxPro.ruilin.magProduceOrder" %>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    <Toolbars>
                        ...
                        Text="清空">
                                 ...
                                 <f:Button ID="btnPrint"   OnClick="btnPrint_Click" ValidateMessageBox="false"  ValidateForms="SimpleForm1"  runat="server" Icon="Disk"  Text="打印生产单">
                                </f:Button>
