...
{
    public partial class searchitemForAdd : PageBase
    {
        ...
        protected void Grid1_RowDoubleClick(object sender, GridRowClickEventArgs e)
        {
            ...
            PageContext.RegisterStartupScript(ActiveWindow.GetWriteBackValueReference(new string[] { Grid1.Rows[Grid1.SelectedRowIndex].Values[0].ToString(), Grid1.Rows[Grid1.SelectedRowIndex].Values[1].ToString(), "1" }) + ActiveWindow.GetHideReference());
            //PageContext.RegisterStartupScript("parent.__doPostBack('','ChildWindowClose');");
        }
