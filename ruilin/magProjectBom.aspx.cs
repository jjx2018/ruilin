    ...
    public partial class magProjectBom : PageBase
    {
        ...
        private void BindGrid()
        {
            using (var appdb = new AppContext())
            {
                ...
                // 排列和数据库分页
                qqq = SortAndPage<ProBomHeader>(qqq, Grid1);
        ...
        private void BindGrid2()
        {
            ...
            using (var appdb = new AppContext())
            {
                ...
                var inq = from a in appdb.probomdtl
                          where a.FSN == pid
                          select a;
                ...
                jObject.Add("ItemNo", "<span style='color:red'>共计：" + inq.Count() + "条</span>");
                            ...
                            else
                            {
                                ...
                                if(tstr.Length>=6)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        //Alert.Show(tstr + "::::" + reg.Match(tstr).Success.ToString());
