<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showNewOrder.aspx.cs" Inherits="AppBoxPro.ruilin.showNewOrder" %>
    ...
    <script type="text/javascript">
        function lookOrder(ID, orderno) {
            parent.addExampleTab({
                id: ID + '_tab',
                iframeUrl: 'ruilin/magOrderDetail.aspx?pid=' + escape(ID) + '&od=' + escape(orderno),
                title: '订单明细',
                iconFont: 'sign-in',
