<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProPlan.aspx.cs" Inherits="AppBoxPro.ruilin.ProPlan" %>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                     <f:RowNumberField Width="30px" EnablePagingNumber="true" />
                        <f:BoundField DataField="ProPlanNo" SortField="ProPlanNo" Width="150px" HeaderText="生产计划号" />
                        ...
                        <f:BoundField DataField="Quantity" SortField="Quantity" Width="120px" HeaderText="生产数量" />
                        <f:BoundField DataField="WorkShop" SortField="WorkShop" Width="120px" HeaderText="生产车间" />
