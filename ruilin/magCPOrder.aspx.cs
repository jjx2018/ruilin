...
{
    public partial class magCPOrder : PageBase
    {
        ...
        private void BindGrid()
        {
            using (var appdb = new AppContext())
            {
                ...
                var qqq = from a in appdb.cporderheader
                          select a;
                ...
                {
                    qqq = qqq.Where(u => u.CPPlanNo.Contains(searchText) || u.CPOrderNo.Contains(searchText));
                }
                ...
                // 排列和数据库分页
                qqq = SortAndPage<CPOrderHeader>(qqq, Grid1);
        ...
        private void BindGrid2()
        {
            ...
            using (var appdb = new AppContext())
            {
                ...
                var inq = from a in appdb.cporderdetail
                ...
                // 排列和数据库分页
                inq = SortAndPage<CPOrderDetail>(inq, Grid2);
