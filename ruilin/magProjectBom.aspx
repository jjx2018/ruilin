<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="magProjectBom.aspx.cs" Inherits="AppBoxPro.ruilin.magProjectBom" %>
            ...
            <Items>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="FileNo"  TextAlign="Center" SortField="FileNo"  Width="200px" HeaderText="文件编号" />
                         <f:WindowField ColumnID="remark" TextAlign="Center" Icon="ApplicationAdd" HeaderText="添加备注" DataToolTipField="Remark" WindowID="Window1"
                            Title="备注" DataIFrameUrlFields="SN" DataIFrameUrlFormatString="~/ruilin/addRemark.aspx?id={0}&t=pmh"
                            Width="90px" />
                ...
                <f:Panel ID="Panel4" Title="面板2" BoxFlex="1" MinHeight="270px" Margin="0"
                  ...
                  <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="false" ShowHeader="false"
                    ...
                    SortDirection="ASC" AllowPaging="false" IsDatabasePaging="false" OnPageIndexChange="Grid2_PageIndexChange" EnableTree="true" TreeColumn="ItemNo" DataIDField="SN" DataParentIDField="ParentSN"  AllowColumnLocking="true" EnableTreeIcons="false" ExpandAllTreeNodes="true">
                    <Toolbars>
                    ...
                    <Columns>
                        <f:RowNumberField  ColumnID="bfRowNum"  EnableTreeNumber="false" />
                                                <f:BoundField  EnableLock="true" Locked="true"  DataField="Seq" TextAlign="Left" SortField="Seq"  Width="90px" HeaderText="序号" />

                        <f:BoundField DataField="ItemNo" ColumnID="ItemNo"  TextAlign="Left" SortField="ItemNo" Width="250px" HeaderText="料号" />
                        <f:BoundField DataField="ItemName"  TextAlign="Left" SortField="ItemName"   Width="250px" HeaderText="名称" />
                        <f:BoundField DataField="Spec"  TextAlign="Left" SortField="Spec"   Width="250px" HeaderText="规格" />
                              
                        <f:BoundField DataField="Material" TextAlign="Center"   Width="100px" HeaderText="材质" />
                       
                        <f:BoundField DataField="SurfaceDeal" TextAlign="Center"  Width="150px" HeaderText="表面处理" />
                         <f:BoundField DataField="ProUsingQuantity"   TextAlign="Center"  Width="60px" HeaderText="用量" />
                        ...
                        <f:BoundField ColumnID="WorkShop" DataField="WorkShop"    Width="90px" HeaderText="生产车间" />      <f:BoundField ColumnID="StoreHouse" DataField="StoreHouse"    Width="80px" HeaderText="仓库" /> 
                         <f:WindowField ColumnID="remark" TextAlign="Center" Icon="ApplicationAdd" HeaderText="添加备注" DataToolTipField="Remark" WindowID="Window1"
                            Title="备注" DataIFrameUrlFields="SN" DataIFrameUrlFormatString="~/ruilin/addRemark.aspx?id={0}&t=pmd"
                            Width="80px" />
