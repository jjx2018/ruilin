...
{
    public partial class ProduceBomDetail : PageBase
    {
        public string pstr = "";
        ...
        private void LoadData()
        {
            ...
            using (var appdb = new AppContext())
            {
                ...
                var q = from a in appdb.orderdetail
                        from b in appdb.bombase
                        where a.SN==b.OdtSN && b.SN==SN
                        select a;
        ...
        private void BindGrid2()
        {
            ...
            using (var appdb = new AppContext())
            {
                ...
                var qqq = from a in appdb.bomdtl
                          ...
                          join g in appdb.v_userinfor on a.Updater equals g.userid into g_join
                          from h in g_join.DefaultIfEmpty()
                          where k.SN == SN

                          select new { a.SN, a.FSN, a.Seq, a.ItemNo, a.ItemName, a.Spec, a.Material, a.SurfaceDeal, a.OrderUsingQuantity, a.Sclass, a.MainFrom, a.WorkShop, a.ZuHe, a.SUBSN, a.ParentSN, a.ProUsingQuantity, SupplierId = d.SupplierId == null ? "" : d.SupplierId.ToString(), a.ZongCheng, a.BaseNum, a.StoreHouse, a.AllitemSN, a.IsValid, ISN = f.SN.ToString(), Updater = h.ChineseName, a.UpdateDate };
                ...
                if (Grid2.GetModifiedData().Count != 0)
                {
                    ...
                    foreach (int rowIndex in modifiedDict.Keys)
                    {
                        if (!modifiedDict[rowIndex].ContainsKey("SupplierId"))
                        {
                            ...
                            //sql = sql.TrimEnd(new char[] { ',' });
                            sql += "updater='"+User.Identity.Name+ "',UpdateDate=getdate() ";
        ...
        protected void Grid2_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            if (User.Identity.Name != "admin")
            {
                ...
                {
                    e.CellCssClasses[15] = "f-grid-cell-uneditable";
                }
            }
        }
