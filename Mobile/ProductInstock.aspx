<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductInstock.aspx.cs" Inherits="AppBoxPro.Mobile.ProductInstock" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" AutoScroll="true" ID="Panel1" IsFluid="true">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" Title="生产入库" runat="server" HeaderStyle="true">
                </f:Toolbar>
            </Toolbars>
            <Items>
                <f:Grid runat="server" ShowBorder="false" ShowHeader="false" ID="Grid1" Height="150px" AllowCellEditing="true">
                    <Columns>
                        ...
                        <f:RenderField DataField="targetqut" HeaderText="生产量" ColumnID="targetqut">
                        </f:RenderField>
    ...
    <script>
        ...
        var storagename = 'productinstock';
